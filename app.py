...
# === Annotate page ===
if page == "Annotate":
    if st.session_state.report_index < len(st.session_state.shuffled_data):
        row = st.session_state.shuffled_data.iloc[st.session_state.report_index]
        report_index = st.session_state.report_index + 1  # human-friendly
